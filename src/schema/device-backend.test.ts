...
describe("DeviceBackend interface (type-level)", () => {
  it("exposes EXACTLY the 12 documented methods — thin/swappable (REQ-IOS-ARCH-005, AC-IOS-026, AC-GEST-008/027, AC-VISION-002/006, AC-GEST2-010 — swipe added SPEC-GESTURE-001 M1, getMinEffectiveSwipeThreshold added M8, getScreenSize added SPEC-VISION-001 M1, the UI-tree read method REMOVED by SPEC-VISION-001 M2/REQ-VISION-002, pinch + doubleTap added SPEC-GESTURE-002 M1/REQ-GEST2-COMMON-004)", () => {
    ...
    // literals rejects both a missing key (if DeviceBackend grows a 13th
    ...
    expect(Object.keys(methodPresence)).toHaveLength(12);
  });
