...
describe("DeviceBackend interface (type-level)", () => {
  it("exposes EXACTLY the 8 documented methods — thin/swappable (REQ-IOS-ARCH-005, AC-IOS-026)", () => {
    ...
    // literals rejects both a missing key (if DeviceBackend grows a 9th
    ...
    expect(Object.keys(methodPresence)).toHaveLength(8);
  });
